...
let testemonials = [
    {quote:'"Mais do que nunca, os automóveis '+
     'são tratados como membros da familia"', origin:'cbs.svg' }, 
    {quote:'"Legalis é um serviço de entrega direto ao '+ 
        'consumidor, com limpezas rápidas e completas"',
        origin:'forbes.svg' }, 
    {quote:'"Legalis usa produtos simples e de ótima qualidade em '+ 
        'seus carros."', origin:'fox.svg' }, 
    {quote:'"Vejo você Legalis como um verdadeiro herói"',
